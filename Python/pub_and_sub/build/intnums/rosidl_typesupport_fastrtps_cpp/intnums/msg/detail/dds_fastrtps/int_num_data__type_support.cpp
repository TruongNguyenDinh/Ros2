...
#include "intnums/msg/detail/int_num_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = intnums::msg::IntNumData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const intnums::msg::IntNumData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<intnums::msg::IntNumData *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IntNumData__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const intnums::msg::IntNumData *>(
...
static size_t _IntNumData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IntNumData(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IntNumData__callbacks = {
  "intnums::msg",
  "IntNumData",
...
static rosidl_message_type_support_t _IntNumData__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IntNumData__callbacks,
...
{
  return &intnums::msg::typesupport_fastrtps_cpp::_IntNumData__handle;
}
